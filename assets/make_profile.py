...
CARDS = [
    ...
    dict(slug="learning-companion", kicker="EDGE AI · CLOUDFLARE", title="AI Learning Companion",
         ...
         art="cards", tone="teal"),
    dict(slug="fakeout", kicker="MACHINE LEARNING", title="FakeOut",
         lines=["Rental-scam detection without labels:",
                "Snorkel labeling functions over 100K",
                "listings and Zillow's rent index."],
         chips=["Python", "Snorkel", "pandas", "scikit-learn"], status=("view repo ↗", "teal"),
         art="hist", tone="coral"),
